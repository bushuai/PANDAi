...
//            $this->dbConn = mysqli_connect($this->dbHost, $this->dbUser, $this->dbPassword, $this->pcon);
            ...
            if ($this->version () > '4.1') {
                $serverset = $this->coding ? "character_set_connection='$this->coding',character_set_database='$this->coding',character_set_server='$this->coding',character_set_results='$this->coding',character_set_client='$this->coding'" : '';
        ...
        {
//            while ($this->mysqli_more_results ()) {
//                $this->next_result ();
//                if ($result = $this->store_result ()) // added closing bracket
//                {
//                    $result->free ();
//                }
//            }
